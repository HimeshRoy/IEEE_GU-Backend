import type { EventFormFieldType, EventParticipationType, RegistrationStatus } from "../../generated/prisma/client.js";
export type { PublicRegistrationInput } from "./registrations.dto.js";
export interface FormAnswerInput {
    [fieldKey: string]: string | number | boolean | string[];
}
...
//# sourceMappingURL=registrations.types.d.ts.map