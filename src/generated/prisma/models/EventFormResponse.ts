...
// @ts-nocheck 
/*
 * This file exports the `EventFormResponse` model and its related types.
 *
...
export type GetEventFormResponseAggregateType<T extends EventFormResponseAggregateArgs> = {
      [P in keyof T & keyof AggregateEventFormResponse]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateEventFormResponse[P]>
    : Prisma.GetScalarType<T[P], AggregateEventFormResponse[P]>
}
...
export type GetEventFormResponseGroupByPayload<T extends EventFormResponseGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<EventFormResponseGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof EventFormResponseGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], EventFormResponseGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], EventFormResponseGroupByOutputType[P]>
      }
    >
  >
...
export type EventFormResponseCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<EventFormResponseFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface EventFormResponseDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['EventFormResponse'], meta: { name: 'EventFormResponse' } }
  /**
   ...
   * })
  **/
  count<T extends EventFormResponseCountArgs>(
    args?: Prisma.Subset<T, EventFormResponseCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], EventFormResponseCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends EventFormResponseGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, EventFormResponseGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetEventFormResponseGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
