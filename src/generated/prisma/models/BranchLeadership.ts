...
// @ts-nocheck 
/*
 * This file exports the `BranchLeadership` model and its related types.
 *
...
export type GetBranchLeadershipAggregateType<T extends BranchLeadershipAggregateArgs> = {
      [P in keyof T & keyof AggregateBranchLeadership]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateBranchLeadership[P]>
    : Prisma.GetScalarType<T[P], AggregateBranchLeadership[P]>
}
...
export type GetBranchLeadershipGroupByPayload<T extends BranchLeadershipGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<BranchLeadershipGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof BranchLeadershipGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], BranchLeadershipGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], BranchLeadershipGroupByOutputType[P]>
      }
    >
  >
...
export type BranchLeadershipCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<BranchLeadershipFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface BranchLeadershipDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['BranchLeadership'], meta: { name: 'BranchLeadership' } }
  /**
   ...
   * })
  **/
  count<T extends BranchLeadershipCountArgs>(
    args?: Prisma.Subset<T, BranchLeadershipCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], BranchLeadershipCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends BranchLeadershipGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, BranchLeadershipGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetBranchLeadershipGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
