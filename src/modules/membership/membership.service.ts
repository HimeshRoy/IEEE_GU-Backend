...
export async function approveMembership(
  ...
  await createNotification({
    ...
    message:
      "Your IEEE GU Student Branch membership has been approved.",
    type: "MEMBERSHIP",
  });
...
export async function applyForMembership(userId: string) {
  ...
  if (existingMembership) {
    if (
      existingMembership.membershipStatus ===
      "PENDING"
    ) {
      throw new Error(
        "Your IEEE membership application is already pending",
      );
    }
    ...
    if (
      ...
      throw new Error(
        "You already have an active IEEE membership",
      );
    }
    ...
    if (
      ...
      throw new Error(
        "Your IEEE membership is currently suspended",
      );
    }
    ...
    if (
      ...
      throw new Error(
        "Your IEEE membership has expired",
      );
    }
    ...
    if (
      ...
      throw new Error(
        "Your previous IEEE membership application was rejected. Please contact the branch administration.",
      );
    }

    throw new Error(
      "A membership profile already exists for this account",
    );
  }
  ...
  await prisma.auditLog.create({
    data: {
      ...
      description:
        "Submitted an IEEE GU Student Branch membership application",
    },
  });
