...
export type CreatePrivilegedUserInput = z.infer<
  typeof createPrivilegedUserSchema
>;
...
export type AssignLeadershipPositionInput = z.infer<
  typeof assignLeadershipPositionSchema
>;
