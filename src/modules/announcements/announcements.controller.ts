...
async function hasManagementAccess(userId: string) {
...
export async function submitAnnouncementController(
  req: Request,
  res: Response,
) {
  try {
    ...
    const message =
      error instanceof Error ? error.message : "Failed to submit announcement";
...
export async function approveAnnouncementController(
  req: Request,
  res: Response,
) {
  try {
    ...
    const message =
      error instanceof Error ? error.message : "Failed to approve announcement";
...
export async function rejectAnnouncementController(
  req: Request,
  res: Response,
) {
  try {
    ...
    const announcement = await rejectAnnouncement(
      req.user.id,
      announcementId,
    ...
    const message =
      error instanceof Error ? error.message : "Failed to reject announcement";
...
export async function unpublishAnnouncementController(
  req: Request,
  res: Response,
) {
  try {
