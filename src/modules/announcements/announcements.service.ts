...
export async function approveAnnouncement(
  ...
  try {
    ...
    console.error(
      "Failed to create announcement approval notification:",
      error,
    );
  }
...
export async function rejectAnnouncement(
  ...
  try {
    ...
    console.error(
      "Failed to create announcement rejection notification:",
      error,
    );
  }
...
export async function publishAnnouncement(
  ...
  try {
    ...
    console.error(
      "Failed to create announcement publication notification:",
      error,
    );
  }
...
export async function deleteAnnouncement(
  ...
  if (announcement.isPublished) {
    throw new Error(
      "Published announcements cannot be deleted. Unpublish them first.",
    );
  }
