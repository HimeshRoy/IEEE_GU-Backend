...
function getErrorStatus(
  ...
  if (
    options.conflict?.some((value) => message.includes(value))
  ) {
    return 409;
  }
...
export async function getEventFormController(
  req: Request,
  res: Response,
) {
  try {
    ...
    const result = await getEventFormByEventId(
      userId,
      eventId,
    );
...
export async function getPublicEventFormController(
  req: Request,
  res: Response,
) {
  try {
...
export async function createEventFormController(
  req: Request,
  res: Response,
) {
  try {
...
export async function updateEventFormController(
  req: Request,
  res: Response,
) {
  try {
...
export async function addEventFormFieldController(
  req: Request,
  res: Response,
) {
  try {
    ...
    const result = await addEventFormField(
      userId,
      formId,
      input,
    );
...
export async function updateEventFormFieldController(
  req: Request,
  res: Response,
) {
  try {
    ...
    const result = await updateEventFormField(
      userId,
      fieldId,
      input,
    );
...
export async function deleteEventFormFieldController(
  req: Request,
  res: Response,
) {
  try {
...
export async function reorderEventFormFieldsController(
  req: Request,
  res: Response,
) {
  try {
    ...
    const result = await reorderEventFormFields(
      userId,
      formId,
      input,
    );
...
export async function publishEventFormController(
  req: Request,
  res: Response,
) {
  try {
    ...
    const result = await publishEventForm(
      userId,
      formId,
    );
...
export async function closeEventFormController(
  req: Request,
  res: Response,
) {
  try {
    ...
    const result = await closeEventForm(
      userId,
      formId,
    );
...
export async function reopenEventFormController(
  req: Request,
  res: Response,
) {
  try {
    ...
    const result = await reopenEventForm(
      userId,
      formId,
    );
...
export async function archiveEventFormController(
  req: Request,
  res: Response,
) {
  try {
    ...
    const result = await archiveEventForm(
      userId,
      formId,
    );
...
export async function deleteEventFormController(
  req: Request,
  res: Response,
) {
  try {
